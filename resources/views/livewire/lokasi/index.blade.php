            ...
            <tbody class="divide-y divide-gray-200 bg-white">
                @forelse ($lokasis as $lokasi)
                    <tr class="hover:bg-blue-50 transition">
                        <td class="px-6 py-4 whitespace-nowrap">{{ $lokasi->nama_lokasi }}</td>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center justify-center gap-3">
                                ...
                                <button wire:click="delete({{ $lokasi->id }})"
                ...
                @empty
                    <tr>
                        <td colspan="3" class="px-6 py-4 text-center text-gray-500 italic">Belum ada data lokasi.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
